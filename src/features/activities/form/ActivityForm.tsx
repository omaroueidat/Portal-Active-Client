...
function ActivityForm() {
    ...
    const {selectedActivity, loadActivity, createActivity, updateActivity, loading, loadingInitial} = activityStore;
    ...
    useEffect(() => {
        if (id) loadActivity(id).then(act => {setActivity(act!); console.log(act?.title)})
